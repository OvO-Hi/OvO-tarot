...
- **AI**: Anthropic Claude API (`@anthropic-ai/sdk`, `ANTHROPIC_API_KEY` 환경변수)
- **배포**: Vercel

## 역할 분담
| 담당 | 작업 범위 |
|------|-----------|
| **Claude Code (나)** | DB 스키마, API Routes 로직, 프롬프트 빌더, 시딩 스크립트, 배포 설정 |
...
## 스프레드 선택 기준 (Claude에게 제공하는 가이드라인)
